...
const customcolor1 = Color(0xFFD0FD3E);
const customcolor2 = Color(0xFF1C1C1E);

CustomColors lightCustomColors = const CustomColors(
  sourceCustomcolor1: Color(0xFFD0FD3E),
  customcolor1: Color(0xFF506600),
  onCustomcolor1: Color(0xFFFFFFFF),
  customcolor1Container: Color(0xFFC6F333),
  onCustomcolor1Container: Color(0xFF161E00),
  sourceCustomcolor2: Color(0xFF1C1C1E),
  customcolor2: Color(0xFF3F5AA9),
  onCustomcolor2: Color(0xFFFFFFFF),
  customcolor2Container: Color(0xFFDBE1FF),
  onCustomcolor2Container: Color(0xFF00174C),
);

CustomColors darkCustomColors = const CustomColors(
  sourceCustomcolor1: Color(0xFFD0FD3E),
  customcolor1: Color(0xFFABD604),
  onCustomcolor1: Color(0xFF283500),
  customcolor1Container: Color(0xFF3C4D00),
  onCustomcolor1Container: Color(0xFFC6F333),
  sourceCustomcolor2: Color(0xFF1C1C1E),
  customcolor2: Color(0xFFB4C5FF),
  onCustomcolor2: Color(0xFF022978),
  customcolor2Container: Color(0xFF244290),
  onCustomcolor2Container: Color(0xFFDBE1FF),
);
