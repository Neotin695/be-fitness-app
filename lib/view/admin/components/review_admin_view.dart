...
class ReviewAdminView extends StatelessWidget {
  ...
  BlocBuilder<AdminCubit, AdminState> buttonSection(
      AdminCubit cubit, RequestOnlineCoachModel request) {
        ...
        return Container(
          ...
          child: Row(
            ...
            children: [
              ElevatedButton.icon(
                onPressed: () async {
                  await cubit.accepteRequest(request.userId);
                },
              ...
              ElevatedButton.icon(
                onPressed: () async {
                  await cubit.rejectRequest(request.userId);
                },
