                  ...
                  ? Column(
                      ...
                      children: [
                        ...
                        ListTile(
                          ...
                          subtitle: Text(
                            'Procnt (${cubit.healthModel!.totalNuration.procnt.label})',
                            style: TextStyle(
                                color: Theme.of(context).colorScheme.primary),
                          ),
                        ...
                        ListTile(
                          ...
                          subtitle: Text(
                            'chole (${cubit.healthModel!.totalNuration.chole.label})',
                            style: TextStyle(
                                color: Theme.of(context).colorScheme.primary),
                          ),
                        ...
                        ListTile(
                          ...
                          subtitle: Text(
                            'NA (${cubit.healthModel!.totalNuration.na.label})',
                            style: TextStyle(
                                color: Theme.of(context).colorScheme.primary),
                          ),
                        ...
                        ListTile(
                          ...
                          subtitle: Text(
                            'CA (${cubit.healthModel!.totalNuration.ca.label})',
                            style: TextStyle(
                                color: Theme.of(context).colorScheme.primary),
                          ),
                        ...
                        ListTile(
                          ...
                          subtitle: Text(
                            'ZN (${cubit.healthModel!.totalNuration.zn.label})',
                            style: TextStyle(
                                color: Theme.of(context).colorScheme.primary),
                          ),
                        ...
                        ListTile(
                          ...
                          subtitle: Text(
                            'Chocdf (${cubit.healthModel!.totalNuration.chocdf.label})',
                            style: TextStyle(
                                color: Theme.of(context).colorScheme.primary),
                          ),
